...
def Send_Cube(name="default",pos=[0,0,0],size=[1,1,1],mass=1.0,colorName='<material name="Blue">',rgba='    <color rgba="0 0 1.0 1.0"/>'):
    ...
    if filetype == SDF_FILETYPE:
        ...
        link = LINK_URDF(name,pos,size,colorName,rgba)
